...
function Footer() {
  return (
    <div>
      <div className="flex pt-15 pl-15 gap-75 border-t-black bg-white border-[1px] py-7 mb-1">
      ...
      <p className="flex gap-1 text-[12px] text-laranja text-bold justify-center "> 
